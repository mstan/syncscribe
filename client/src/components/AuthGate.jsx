      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-brand-100">
            <svg className="h-7 w-7 text-brand-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Error message */}
          {error && (
            <div className="mb-4 w-full rounded-lg bg-red-50 px-4 py-3 text-sm text-red-700">
              {error}
            </div>
          )}
