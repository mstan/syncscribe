...
export default function AuthGate({ onSuccess, onClose, login }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl dark:bg-stone-900 dark:ring-1 dark:ring-stone-700">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {/* Loading state */}
          {loading ? (
            <div className="flex items-center gap-2 py-4 text-sm text-stone-500 dark:text-stone-400">
