  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="w-full max-w-lg rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 flex items-start gap-2.5 rounded-lg bg-brand-50 px-4 py-3">
        ...
        {/* AI disclaimer */}
        <div className="mt-3 flex items-start gap-2.5 rounded-lg bg-amber-50 px-4 py-3">
