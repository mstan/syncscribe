...
Reference character/proper names: ${namesList}

Brief synopsis: ${synopsisBlock}

Speech-to-text often produces phonetic approximations of character names. Your job is to find and fix these. For example, "Ezak" should be "Yzak", "Afrin" should be "Athrun", "Kigali" should be "Cagalli".

Review these subtitles and fix ONLY:
- Character names that are phonetically similar to a reference name (e.g. "Ezak"→"Yzak", "Afrin"→"Athrun", "D'Arca"→"Dearka")
- Misspelled place names, faction names, or show-specific terms (e.g. "ZAP"→"ZAFT")
- Obvious mishearings where the reference data makes the correct word clear
